...
VERBOSE = 1
#------------------------------------- Apartado en donde se llama al archivo del analizador lexico como procedencia de la¿os tokens a usar
precedence = (
...
#---------------------- Formato de impresion en consola y asigancion del analizador sintactico al archivo .js--------------------------
