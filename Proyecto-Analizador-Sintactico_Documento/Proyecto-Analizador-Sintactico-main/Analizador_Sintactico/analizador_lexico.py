...
#Esto son los tokens que maneja el analizar 
tokens = (
...
#Estas son las operacion y expreciones que se tomaran al realizar las busqueda
t_SUMA = r'\+'
t_RESTA = r'-'
t_MULTIPLICACION = r'\*'
t_DIVISION = r'/'
...
#Esto son los lexemas que usara el codigo al momento de la ejecucion 
def t_VOID(t):
    r'VOID|void'
    return t
...
#En este apartado hace la ejecucion del proceso y usa los lexemas
lexer = lex.lex()
codigo = 'codigo.js'
scriptfile = open(codigo, 'r', encoding='UTF-8')
scriptdata = scriptfile.read()
lexer.input(scriptdata)
#Este es el apartado es el cento del codigo porque aqui lee y muestra la ejecucion del codigo lexico
print(
