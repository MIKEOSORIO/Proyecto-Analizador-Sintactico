...
#Estas son varias que usamos para declarar y seran usadas durante la ejecucion 
...
# y en este apartado estan declaradas las funciones  que usara el codigo para el problema
...
# estas son las expreciones que maneja puntoycoma y las demas variantes
...
#Aqui es donde las expreciones toman un lugar o posicion 
def p_var(p):
	'''var : VARIABLE
...
#Este apartado es de las expreciones matematicas o de operaciones 
def p_addop(p):
	'''addop : SUMA
			 | RESTA
	'''
...
#Apartado de las expreciones de lista o de coma lista
def p_args(p):
	'''args : args_list
			| empty
			| VOID
...
#Aqui es donde el codigo ejecuta las funciones y las pasa a tipo resultado y muestra si hay o no hay error 
parser = yacc.yacc()
...
#En esta parte muestra si hay error si no hay manda ese frase pero si hay muestra el error 
